...
import 'package:pulse_social/widgets/follow.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  getData() async {
    ...
    try {
      var Usersnap = await FirebaseFirestore.instance.collection('users').doc(
          widget.uid).get();
      //Getting post length
      var posSnap = await FirebaseFirestore.instance.collection('posts').where(
          'uid', isEqualTo:
      FirebaseAuth.instance.currentUser!.uid).get();
      postLen = posSnap.docs.length;
  ...
  Widget build(BuildContext context) {
    ...
    Column buildState(int num,String label){
      return Column(
